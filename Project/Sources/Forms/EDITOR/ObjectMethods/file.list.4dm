...
Case of 
	...
	: ($Lon_formEvent=On Selection Change:K2:29)
		...
		If ($Lon_row>0)
			...
			Else 
				...
				// File row
				If (Form:C1466.files[Form:C1466.files.extract("name").indexOf((Form:C1466.dynamic("file"))->{$Lon_row})].platformPath#Null:C1517)
	...
	: ($Lon_formEvent=On Expand:K2:41)
		...
		If (Form:C1466.files[$Lon_row-1].platformPath=Null:C1517)
