...
Case of 
	...
	: ($Lon_formEvent=On Load:K2:1)\
		...
		OBJECT SET RGB COLORS:C628(*;"search.border";0x00E5E5E5;Background color none:K23:10)
	...
	: ($Lon_formEvent=On Getting Focus:K2:7)
		...
		OBJECT SET RGB COLORS:C628(*;"search.border";Highlight text background color:K23:5;Background color none:K23:10)
		
		  // Restore default colors
		OBJECT SET RGB COLORS:C628(*;"unit.search";Foreground color:K23:1;Background color:K23:2)
		
		
		  //OBJECT SET VISIBLE(*;"restart_";Length($Ptr_me->)>0)
