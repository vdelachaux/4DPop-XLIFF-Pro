...
Case of 
	...
	: ($Lon_formEvent=On Load:K2:1)
		...
		GET DOCUMENT PROPERTIES:C477(Form:C1466.platformPath; $Boo_Locked; $Boo_Invisible; $Dat_Created; $Gmt_Created; $Dat_Modified; $Gmt_Modified)
		...
		Form:C1466.size:=doc_gTxt_BytesToString(Get document size:C479(Form:C1466.platformPath))
		
		If (Position:C15(Get localized string:C991("Bytes"); Form:C1466.size)=0)
			
			Form:C1466.size:=Form:C1466.size+" ("+doc_gTxt_BytesToString(Get document size:C479(Form:C1466.platformPath); "O")+")"
			
		End if 
		
		$Txt_Buffer:=Document to text:C1236(Form:C1466.platformPath)
