...
Case of 
	...
	: ($Txt_name="trans-unit")
		...
		//$Dom_nodeRef:=DOM Find XML element($Dom_nodeRef; "trans-unit/target")
		$Dom_nodeRef:=DOM Find XML element:C864($Dom_nodeRef; "target")
	...
	: ($Txt_name="source")\
		...
		If (Asserted:C1132(Length:C16($Dom_unit)>0))
			...
			//$Dom_nodeRef:=DOM Find XML element($Dom_unit; "trans-unit/target")
			$Dom_nodeRef:=DOM Find XML element:C864($Dom_unit; "target")
