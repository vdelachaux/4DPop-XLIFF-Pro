...
If (Asserted:C1132($Lon_parameters>=1;"Missing parameter"))
	...
	End if 
	  ...
	  //$Txt_database:=Replace string(Structure file;Get 4D folder(Database folder);"")
	  //$Txt_database:=Replace string($Txt_database;".4db";"")
	  //$Txt_database:=Replace string($Txt_database;".4dc";"")
	  //$Txt_message:="["+$Txt_database+"] "+$Txt_message
	
	$Txt_message:="["+Path to object:C1547(Structure file:C489).name+"] "+$Txt_message
